...
export const HomePage = () => {
  return (
    <div className="flex flex-col">
      {/* Hero Banner */}
      <section className="relative h-[80vh] flex items-center justify-center text-center bg-pink-700">
        <img 
      ...
      <section className="py-20 px-4 container mx-auto text-center ">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="p-6 border border-black">
            <h3 className="font-heading text-xl text-pink-800 mb-4">Visagismo</h3>
            <p className="text-sm">Design personalizado que revela sua melhor versão.</p>
          </div>
          <div className="p-6 border  border-black">
            <h3 className="font-heading text-xl text-pink-800 mb-4">Tratamentos Premium</h3>
            <p className="text-sm">Tecnologia avançada em cuidados capilares e pele.</p>
          </div>
          <div className="p-6 border  border-black">
            <h3 className="font-heading text-xl text-pink-800 mb-4 ">Ambiente Sofisticado</h3>
